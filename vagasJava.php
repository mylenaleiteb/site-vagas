...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const fileName = 'arquivosJson/scrapping_vagas_java.json'; // Nome do seu arquivo JSON

            fetch(fileName)
                .then(response => response.json())
                .then(data => {
                    const limitedData = data.slice(0, 20); // Limita a 20 linhas
    ...
    <?php
    include_once 'footerLinguagem.php';
    ?>
